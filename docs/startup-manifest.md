...
- Telemetry rule: use `./tools/codex-usage probe-sources` to find local telemetry, then `ingest-jsonl` or `ingest-state-sqlite` to build the ledger. The old governor spike is archived under `archive/governor-spike-20260420/`.
